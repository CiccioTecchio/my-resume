...
\highlightbar{
    ...
    \vspace{0.5em}
    \homepage{cicciotecchio.io}{https://cicciotecchio.github.io/CiccioTecchio.io/}
...
\mainbar{
    ...
    \job{03-2022 - Current}
        {Myself}
        {Cicciotecchio.io}
        {My personal website, actually is developed in JQuery now I'm restructuring it with React (branch dev-react).  \textbf{Technology stack}: JQuery, Bootstrap, React, GhPages. \href{https://github.com/CiccioTecchio/CiccioTecchio.io}{Link to GitHub Repo}.}
    \job{04/2022 - Current}
        {Myself}
        {RandomQuestion}
